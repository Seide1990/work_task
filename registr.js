...
for(i of array1){
    if (array.includes(i)){
 return alert('adinizi daxil etdikde reqemden istifade etmeyin')}
}
value2=value2.trim();
if (value2.length>=8 && value2.length<=20){
  ...
  return alert(' sifrenizin sayi 8 den boyuk 20 den kicik olmalidir')
}
}
else{
    return  alert('adinizin uzunlugu 3 simvoldan boyuk 8 simvoldan kicik olmalidi')
}}
